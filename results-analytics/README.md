...
- If the upstream API requires authentication, set these environment variables in Vercel or your local `.env` file:
  - `RESULTS_API_URL`
- If you do not have an API key, the app will fall back to scraping the public academic results page through the serverless function.
